        ...
        <div class="bg-gray-100">
            <div class="grid h-full grid-cols-1 py-24">
                <div class="container grid grid-cols-1 mx-auto lg:flex">
                    <div class=" w-[66%] ">
                        <img src="{{ asset($career->img) }}" alt=""
                            class="object-contain w-full h-auto border rounded-3xl">
                    </div>
                    <div class="flex flex-col items-start justify-between w-1/3 p-10 ">
                        ...
                        <div class="flex flex-col gap-3">
                            <div>
                                <span
                                    class="{{ $career->type === 'Part-time' ? 'bg-yellow-500 text-black' : 'bg-blue-600 text-white' }} px-2 py-1 text-md font-medium rounded">
                                    {{ $career->type }}
                                </span>
                            </div>
                    ...
                    <div class="container grid grid-cols-1 gap-8 px-4 py-10 mx-auto lg:grid-cols-3">
                        ...
                        <div class="col-span-2 space-y-8">
                            ...
                            <div class="p-6 bg-white shadow rounded-xl">
                                ...
                                <div class="grid grid-cols-3 pt-3 space-y-3">
                                    ...
                                    <section class="flex items-center col-span-1 gap-3">
                                        <img src="{{ asset('assets/career-icon2.png') }}" alt="" class="w-auto h-4">
                            ...
                            <div>
                                ...
                                <ul class="space-y-2 text-gray-700">
                                    @foreach ($career->key_responsibilty as $item)
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="overflow-hidden rounded-2xl">
                                ...
                                <div>
                                    <div class="flex flex-col gap-5 p-5 bg-white divide-y shadow">
                                        <div class="flex items-center p-3 space-x-3">
                                            <img src="{{ asset('assets/careers-img1.png') }}" alt="img"
                                                class="object-cover w-auto h-20 rounded-md" />
                                            <div class="flex flex-col w-full gap-3">
                                                <div>
                                                    <div class="font-semibold">Medical Technologist</div>
                                                    <p class="text-sm text-gray-500">Posted 4 months ago</p>
                                                </div>
                                                <div class="flex justify-between">
                                                    ...
                                                    <div
                                                        class="inline-block px-2 py-1 mt-1 text-xs text-white bg-blue-600 rounded">
                                                        Full-time</div>
                                                </div>
                                            </div>
                                        </div>
