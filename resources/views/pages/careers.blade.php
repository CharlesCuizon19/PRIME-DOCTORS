                                            ...
                                            <a href="{{ route('careers.show', $career->id) }}">
                                                <div
                                                    ...
                                                    <div class="overflow-hidden">
                                                        <img src="{{ asset($career->img) }}" alt="Job Image"
                                                            class="object-cover w-full transition duration-300 lg:h-48 group-hover:scale-105">
                                                    </div>
                                                    <div class="flex flex-col p-4 space-y-3 bg-white">
                                                        <div class="flex flex-col gap-1 mb-5">
                                                            <div class="flex items-start justify-between">
                                                                <h3 class="text-lg font-semibold">{{ $career->title }}</h3>
                                                                <span
                                                                    class="{{ $career->type === 'Part-time' ? 'bg-yellow-500 text-gray-700' : 'bg-blue-600 text-white' }} px-2 py-1 text-xs font-medium rounded">
                                                                    {{ $career->type }}
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div
                                                        class="flex items-center justify-between p-4 text-sm text-gray-600 bg-[#f8f9fc]">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            <div>
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 1024 1024" class="w-auto h-3">
