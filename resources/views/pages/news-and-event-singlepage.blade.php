            ...
            <div class="w-full lg:w-2/3">
                ...
                <div class="flex items-center gap-8 mb-3 text-sm text-gray-600">
                    ...
                    <p class="flex items-center justify-start gap-2 mb-2 text-sm text-[#edb42f]">
                        ...
                        <span>{{ \Carbon\Carbon::parse($news->date)->format('F d, Y') }}</span>
                    </p>
                    <p class="flex items-center justify-start gap-2 mb-2 text-sm text-[#edb42f]">
                ...
                <div class="pt-5 space-y-6 leading-relaxed text-gray-700">
                    <p>
                        In today’s fast-paced world, many people tend to visit the doctor only when they are already feeling
                        unwell. However, regular health check-ups play a vital role in maintaining good health, detecting
                        potential
                        issues early, and ensuring a longer, healthier life.
                    </p>
