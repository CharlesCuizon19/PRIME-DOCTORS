    ...
    <div class="container grid items-center justify-center max-w-6xl gap-10 p-6 mx-auto text-center lg:grid-cols-1">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div class="overflow-hidden transition duration-300 cursor-pointer hover:scale-105">
                <img src="{{ asset('assets/news-img1.png') }}" alt="Health Check-Up"
                ...
                <div class="py-4">
                    ...
                    <h2 class="text-base font-semibold text-gray-800 lg:text-lg text-start">The Importance of
                        Regular Health
                        Check-Ups
                    </h2>
                </div>
            ...
            <div class="overflow-hidden transition duration-300 cursor-pointer hover:scale-105">
                <img src="{{ asset('assets/news-img2.png') }}" alt="Health Check-Up"
                    class="object-cover w-full h-[70%] rounded-2xl">
                <div class="py-4">
                    <p class="flex items-center justify-start gap-2 mb-2 text-sm text-[#edb42f]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <h2 class="text-base font-semibold text-gray-800 lg:text-lg text-start">How to Manage Stress
                        for Better
                        Mental Health
                    </h2>
                </div>
            ...
            <div class="overflow-hidden transition duration-300 cursor-pointer hover:scale-105">
                <img src="{{ asset('assets/news-img3.png') }}" alt="Health Check-Up"
                    class="object-cover w-full h-[70%] rounded-2xl">
                <div class="py-4">
                    <p class="flex items-center justify-start gap-2 mb-2 text-sm text-[#edb42f]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <h2 class="text-base font-semibold text-gray-800 lg:text-lg text-start">Understanding the Signs
                        of a Medical
                        Emergency
                    </h2>
                </div>
            ...
            <div class="overflow-hidden transition duration-300 cursor-pointer hover:scale-105">
                <img src="{{ asset('assets/news-img4.png') }}" alt="Health Check-Up"
                    class="object-cover w-full h-[70%] rounded-2xl">
                <div class="py-4">
                    <p class="flex items-center justify-start gap-2 mb-2 text-sm text-[#edb42f]">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <h2 class="text-base font-semibold text-gray-800 lg:text-lg text-start">Preparing for Your
                        First Hospital
                        Visit: A
                        Patient's Guide</h2>
                </div>
