                    ...
                    <div class="absolute inset-0">
                        <div class="grid items-center h-full grid-cols-1 2xl:grid-cols-5">
                            <div class="ml-[10rem] col-span-2 w-fit">
                                <img src="{{ asset($doctor->profile_img_id ? $doctor->profile_img_id : 'assets/doctor-thumbnail2.png') }}"
                                    alt="" class="rounded-[15px] h-[24rem] w-auto shadow-black drop-shadow-md">
                            </div>
